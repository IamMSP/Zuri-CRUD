...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\user\Desktop\zuri_django\Zuri-CRUD\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\user\Desktop\zuri_django\Zuri-CRUD\env\Scripts\deactivate.nu'
